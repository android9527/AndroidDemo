...
public class RootActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.depth_activity_root);
        makeAppFullscreen();
    ...
    private void setupMenu() {
        ...
        addMenuItem(menu, "Water And Noise", R.drawable.depth_splash1, color, R.drawable.depth_menu_btn, 0);
        addMenuItem(menu, "Two Bears", R.drawable.depth_splash2, getResources().getColor(R.color.splash2), R.drawable.depth_menu_btn2, 1);
        addMenuItem(menu, "Depth Playground", R.drawable.depth_splash3, getResources().getColor(R.color.splash3), R.drawable.depth_menu_btn3, 2);
        addMenuItem(menu, "About", R.drawable.depth_splash4, getResources().getColor(R.color.splash4), R.drawable.depth_menu_btn4, 3);
    ...
    private void addMenuItem(ViewGroup menu, String text, int drawableResource, int splashColor, int menu_btn, int menuIndex) {
        ViewGroup item = (ViewGroup) LayoutInflater.from(this).inflate(R.layout.depth_menu_item, menu, false);
